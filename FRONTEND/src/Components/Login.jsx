              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-14 pl-12 pr-4 rounded-xl border border-slate-200 bg-white text-slate-900 outline-none transition focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 placeholder:text-slate-400"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-14 pl-12 pr-12 rounded-xl border border-slate-200 bg-white text-slate-900 outline-none transition focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10 placeholder:text-slate-400"
                  />
