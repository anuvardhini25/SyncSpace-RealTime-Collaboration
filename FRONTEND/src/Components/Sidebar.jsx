    ...
    <div className="w-72 bg-[#111827] text-gray-300 flex flex-col justify-between h-full border-r border-gray-800">
      <div className="flex-1 overflow-y-auto">
        <div className="flex items-center px-6 py-6 border-b border-gray-800">
          <div className="bg-gradient-to-br from-violet-600 to-indigo-600 p-1.5 rounded-md mr-3 shadow-sm shadow-violet-600/20">
      ...
      <div className="shrink-0 border-t border-gray-800">
        <button
          onClick={toggleTheme}
          className="w-full flex items-center gap-3 px-6 py-3 text-sm text-gray-400 hover:text-white hover:bg-gray-800 transition-colors"
        >
          {theme === 'dark' ? <Sun size={16} /> : <Moon size={16} />}
          {theme === 'dark' ? 'Light mode' : 'Dark mode'}
        </button>

        <div className="px-6 py-4 flex items-center justify-between hover:bg-gray-800 transition-colors border-t border-gray-800">
