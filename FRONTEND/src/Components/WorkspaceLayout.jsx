...
export default function WorkspaceLayout() {
  ...
  return (
    <div className="flex h-screen w-full bg-gray-100 dark:bg-gray-950 font-sans overflow-hidden">
      <Sidebar activeRoomId={roomId} />
      <div className="flex flex-1 flex-col h-full w-full relative">
        <Topbar room={room} roomId={roomId} users={users} connected={connected} onOpenReplay={() => setReplayOpen(true)} />
        <Workspace />
