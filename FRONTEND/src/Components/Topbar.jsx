...
import { Menu, Users, Link as LinkIcon, Check, Wifi, WifiOff } from "lucide-react";
import { disconnectSocket } from "../socket";

export default function TopBar({ room, users = [], connected }) {
    ...
    <div className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 shrink-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          disabled={!roomCode}
          className="border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors disabled:opacity-50"
        >
