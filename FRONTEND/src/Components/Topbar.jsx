...
import { ReactionPicker } from "./ReactionLayer";

export default function TopBar({ room, roomId, users = [], connected, onOpenReplay }) {
  ...
  return (
    <div className="h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 shrink-0">
      <div className="flex items-center gap-4">
        <button className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md text-gray-600 dark:text-gray-300">
          <Menu size={20} />
        </button>
        <div className="flex items-center gap-3">
          <h1 className="font-semibold text-gray-800 dark:text-gray-100 text-lg">{roomName}</h1>
          <div className="flex items-center gap-1 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md text-xs font-medium text-gray-600 dark:text-gray-300">
            <Users size={14} />
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors"
        >
          <History size={16} />
          Replay
        </button>
