...
export default function roomSocket(io, socket) {
  ...
  // Lightweight ephemeral emoji reactions (topbar picker -> floats on
  // everyone's screen). Not persisted anywhere - purely a live nicety,
  // so it just re-broadcasts to the room instead of touching MongoDB.
